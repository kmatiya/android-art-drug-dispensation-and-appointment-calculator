...
public class ABC3TC implements MedicineService {
    ...
    public ABC3TC()
    {
        ...
        medicineDosage.put(WeightRangeMapper.LESS_THAN_THIRTY, DosageAndWeightMapper.setDosageAndWeightOfMedicine(25,29.9,1,0,MedicineType.TABLET,DosageRecipientType.ADULT));
    ...
    public String getName() {
        return MedicineNameMetaData.ABC_3TC;
    }
